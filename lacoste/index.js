...
function limparCamposZendesk() {
    ...
    const clothingOptions = document.querySelector('.clothing-options');
    ...
    wherePurchadeWasMade.addEventListener('change', () => {
        ...
        if (problemValueBuy === 'site_oficial_da_lacoste') {
            showElements([receiptProductMethodSpan, receiptProductMethod, paymentMethodSpan, paymentMethod]);
            ...
            showElements([ ]);
            hideElements([brandInputSpan, brandInput, receiptProductMethodSpan, receiptProductMethod, paymentMethodSpan, paymentMethod, marketplacePurchaseLocation, marketplacePurchaseLocationSpan]);
        }else if(problemValueBuy === 'multimarca'){
            showElements([brandInput, brandInputSpan]);
            hideElements([receiptProductMethodSpan, receiptProductMethod, paymentMethodSpan, paymentMethod, marketplacePurchaseLocation, marketplacePurchaseLocationSpan]);
        }
      ...
      async function criarTicketZendeskOrder() {
        ...
        const payloadTicket = {
            request: {
                ...
                custom_fields: updateCustomFields(customFields),
                tags: [
                    "form_guide_brasil"
                ]
            }
